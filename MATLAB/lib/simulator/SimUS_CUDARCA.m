function [Raw ] = SimUS_CUDARCA(Media, TransTX, TransRX, TXSI, RXSI, Options)
...
% Transmit
TXfieldKernel = parallel.gpu.CUDAKernel('SimUS_CUDARCA.ptx', ...
...
% Receive
RXfieldKernel = parallel.gpu.CUDAKernel('SimUS_CUDARCA.ptx', ...
    ['float2*,' ...         % Output Pfield
    'const float*,' ...     % r_scat
    'const float*,' ...     % r_ele
    'const float2*, ' ...   % kWaveNumber
