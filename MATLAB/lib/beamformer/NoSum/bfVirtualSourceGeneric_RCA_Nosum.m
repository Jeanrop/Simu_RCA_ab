function [dataBf, mask] = bfVirtualSourceGeneric_RCA_Nosum(varargin)
...
%% DO BF WITH CUDA
%--- CUDA kernel
cudaKernel = parallel.gpu.CUDAKernel('bfVirtualSourceGeneric_RCA_Nosum.ptx',...
    'bfVirtualSourceGeneric_RCA_Nosum.cu',...
    'bfVirtualSourceGeneric_RCA_Nosum'); % Create CUDA object
...
function compilePTX
    ...
    system(['nvcc -ptx bfVirtualSourceGeneric_RCA_Nosum.cu -use_fast_math -ccbin ', ...
            '"' cudaSelected '"']);
