function [dataBf, mask] = bfVirtualSourceGeneric_RCA_ab_1(varargin)
...
%% DO BF WITH CUDA
%--- CUDA kernel
cudaKernel = parallel.gpu.CUDAKernel('bfVirtualSourceGeneric_RCA_ab_1.ptx',...
    'bfVirtualSourceGeneric_RCA_ab_1.cu',...
    'bfVirtualSourceGeneric_RCA_ab_1'); % Create CUDA object
...
function compilePTX
    ...
    system(['nvcc -ptx bfVirtualSourceGeneric_RCA.cu -use_fast_math -ccbin ', ...
            '"' cudaSelected '"']);
