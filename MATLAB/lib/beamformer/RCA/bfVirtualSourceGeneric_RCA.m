function [dataBf, mask] = bfVirtualSourceGeneric_RCA(varargin)
...
%% DO BF WITH CUDA
%--- CUDA kernel
cudaKernel = parallel.gpu.CUDAKernel('bfVirtualSourceGeneric_RCA.ptx',...
    'bfVirtualSourceGeneric_RCA.cu',...
    'bfVirtualSourceGeneric_RCA'); % Create CUDA object
