function [dataBf, mask] = bfVirtualSourceGeneric(varargin)
...
%% DO BF WITH CUDA
%--- CUDA kernel
cudaKernel = parallel.gpu.CUDAKernel('bfVirtualSourceGeneric.ptx',...
    'bfVirtualSourceGeneric.cu',...
    'bfVirtualSourceGeneric'); % Create CUDA object
...
function compilePTX
    ...
    system(['nvcc -ptx bfVirtualSourceGeneric.cu -use_fast_math -ccbin ', ...
            '"' cudaSelected '"']);
