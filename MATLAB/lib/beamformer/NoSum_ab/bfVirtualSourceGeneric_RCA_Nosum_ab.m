function [dataBf, mask] = bfVirtualSourceGeneric_RCA_Nosum_ab(varargin)
...
%% DO BF WITH CUDA
%--- CUDA kernel
cudaKernel = parallel.gpu.CUDAKernel('bfVirtualSourceGeneric_RCA_Nosum_ab.ptx',...
    'bfVirtualSourceGeneric_RCA_Nosum_ab.cu',...
    'bfVirtualSourceGeneric_RCA_Nosum_ab'); % Create CUDA object
...
function compilePTX
    ...
    system(['nvcc -ptx bfVirtualSourceGeneric_RCA_Nosum_ab.cu -use_fast_math -ccbin ', ...
            '"' cudaSelected '"']);
